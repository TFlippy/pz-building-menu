...
ISCustomFloor = ISBuildingObject:derive("ISCustomFloor");

--************************************************************************--
--** ISCustomFloor:new
--**
--************************************************************************--
function ISCustomFloor:create(x, y, z, north, sprite)
...
function ISCustomFloor:new(sprite, northSprite)
	local o = {};
	setmetatable(o, self);
	self.__index = self;
	o:init();
...
function ISCustomFloor:isValid(square)
...
function ISCustomFloor:render(x, y, z, square)
